    ...
    <>
      <header className="relative flex flex-col md:flex-row gap-5 md:gap-32 justify-between md:items-center bg-gray-200 py-8 md:py-24 px-4 md:px-12 lg:px-28">
        ...
        <p className="relative z-10 max-w-xl text-base text-gray-500">
          Deze gebruiksvoorwaarden beschrijven de voorwaarden waaronder u onze website bezoekt en gebruikt. Door gebruik te maken van onze site, stemt u in met deze voorwaarden.
        </p>
      </header>
      <section className="flex flex-col gap-6 py-12 md:py-24 md:pt-20 px-4 md:px-12 lg:px-28">
        <div>
          <h2 className="text-xl font-semibold text-gray-900 md:text-2xl uppercase">Algemene Voorwaarden</h2>
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900 md:text-2xl uppercase">Nauwkeurigheid, Volledigheid en Tijdigheid van Informatie</h2>
          <p className="text-base text-gray-900 mt-2">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900 md:text-2xl uppercase">Wijzigingen in de Dienst</h2>
          <p className="text-base text-gray-900 mt-2">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900 md:text-2xl uppercase">Auteursrechten en Intellectuele Eigendom</h2>
          <p className="text-base text-gray-900 mt-2">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900 md:text-2xl uppercase">Gebruikersreacties, Feedback en Andere Inzendingen</h2>
          <p className="text-base text-gray-900 mt-2">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900 md:text-2xl uppercase">Persoonlijke Informatie</h2>
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900 md:text-2xl uppercase">Verboden Gebruik</h2>
          <p className="text-base text-gray-900 mt-2">
            ...
            beveiligingsfuncties van de site te omzeilen.
          </p>
        </div>
        <div>
          <h2 className="text-xl font-semibold text-gray-900 md:text-2xl uppercase">Beperking van Aansprakelijkheid</h2>
          <p className="text-base text-gray-900 mt-2">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900 md:text-2xl uppercase">Toepasselijk Recht</h2>
          <p className="text-base text-gray-900 mt-2">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900 md:text-2xl uppercase">Wijzigingen aan de Gebruiksvoorwaarden</h2>
          <p className="text-base text-gray-900 mt-2">
            ...
            controleren op wijzigingen. Uw voortgezet gebruik van of toegang tot onze website na het plaatsen van wijzigingen houdt in dat u deze wijzigingen accepteert.
          </p>
        </div>
        <div>
          <h2 className="text-xl font-semibold text-gray-900 md:text-2xl uppercase">Contactinformatie</h2>
          <p className="text-base text-gray-900 mt-2">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900 md:text-2xl uppercase">Wijzigingen in deze Gebruiksvoorwaarden</h2>
